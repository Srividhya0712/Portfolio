  ...
  return (
    <main>
      ...
      >
        ...
        <p className="relative z-10 mb-4 text-xl font-medium text-accent">
          Hey, I&apos;m Srividhya{" "}
          <span className="inline-block animate-bounce">👋</span>
        </p>

        <h1 className="relative z-10 max-w-4xl text-5xl font-extrabold leading-tight tracking-tight text-text-primary sm:text-6xl md:text-7xl">
        ...
        <p className="relative z-10 mt-6 max-w-2xl text-xl leading-relaxed text-text-secondary">
        ...
        <div className="relative z-10 mt-10 flex flex-wrap items-center justify-center gap-4">
          <a
            href="#projects"
            className="rounded-full bg-accent px-10 py-4 text-base font-semibold text-white shadow-lg shadow-accent/20 transition-all hover:bg-accent-dark hover:shadow-xl hover:shadow-accent/30 hover:-translate-y-0.5"
          >
            View Projects
          </a>
          <a
            href="#contact"
            className="rounded-full border border-border bg-white px-10 py-4 text-base font-semibold text-text-primary shadow-sm transition-all hover:border-accent hover:text-accent hover:-translate-y-0.5"
          >
            Get in Touch
          </a>
        </div>
      ...
      <section id="about" className="py-24 px-6">
        <div className="mx-auto max-w-4xl">
          ...
          <h2 className="mt-2 text-4xl font-bold text-text-primary sm:text-5xl">
            ...
            <div className="space-y-5 text-lg text-text-secondary leading-relaxed">
              ...
              <div className="flex flex-wrap gap-3 pt-2">
                {["End-to-End Ownership", "Clean Architecture", "User-Focused"].map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full bg-accent-soft px-5 py-2 text-sm font-semibold text-accent-dark"
                  >
                    {tag}
                  </span>
                ))}
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-6">
            {[
              ...
              <div
                key={hobby.label}
                className="flex items-center gap-3 rounded-full bg-sage-soft px-6 py-3 text-base font-medium text-sage border border-sage/10"
              >
        ...
        <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <a
              ...
              className="flex items-center gap-2 rounded-full bg-white px-7 py-3.5 text-base font-semibold text-text-primary shadow-sm border border-border hover:border-accent hover:text-accent hover:-translate-y-0.5 transition-all"
            >
      ...
      {/* ═══════════════════ FOOTER ═══════════════════ */}
      <footer className="border-t border-border-light py-8 px-6 text-center text-base text-text-muted">
        <p>
...
function SectionLabel({ children }: { children: React.ReactNode }) {
  return (
    <span className="inline-block rounded-full bg-accent-soft px-5 py-2 text-sm font-semibold tracking-wider uppercase text-accent-dark">
      {children}
    </span>
  );
}
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 space-y-4">
        ...
        <p className="text-base font-medium text-accent">{problem}</p>
        ...
        <div className="flex flex-wrap gap-2 pt-1">
          {tags.map((tag) => (
            <span
              key={tag}
              className="rounded-full bg-accent-soft/60 px-4 py-1.5 text-sm font-medium text-accent-dark"
            >
              {tag}
            </span>
          ))}
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 mt-2 text-base font-semibold text-accent hover:text-accent-dark transition-colors"
        >
          <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24">
            <path d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577 0-.285-.01-1.04-.015-2.04-3.338.724-4.042-1.61-4.042-1.61C4.422 18.07 3.633 17.7 3.633 17.7c-1.087-.744.084-.729.084-.729 1.205.084 1.838 1.236 1.838 1.236 1.07 1.835 2.809 1.305 3.495.998.108-.776.417-1.305.76-1.605-2.665-.3-5.466-1.332-5.466-5.93 0-1.31.465-2.38 1.235-3.22-.135-.303-.54-1.523.105-3.176 0 0 1.005-.322 3.3 1.23.96-.267 1.98-.399 3-.405 1.02.006 2.04.138 3 .405 2.28-1.552 3.285-1.23 3.285-1.23.645 1.653.24 2.873.12 3.176.765.84 1.23 1.91 1.23 3.22 0 4.61-2.805 5.625-5.475 5.92.42.36.81 1.096.81 2.22 0 1.606-.015 2.896-.015 3.286 0 .315.21.69.825.57C20.565 22.092 24 17.592 24 12.297c0-6.627-5.373-12-12-12" />
          </svg>
...
function SkillGroup({
  ...
  return (
    <div className="rounded-2xl bg-bg-warm p-6 border border-border-light">
      <h3 className="text-base font-bold text-accent uppercase tracking-wider mb-4">
        {title}
      </h3>
      <div className="flex flex-wrap gap-2">
        {skills.map((skill) => (
          <span
            key={skill}
            className="rounded-lg bg-white px-4 py-2 text-base font-medium text-text-primary border border-border-light hover:border-accent hover:text-accent transition-all cursor-default"
          >
            {skill}
          </span>
        ))}
